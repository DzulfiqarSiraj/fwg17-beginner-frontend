            ...
            <div className="flex flex-col max-w-3xl w-full bg-white h3/6 mt-16 mb-16">
                ...
                <form action="" className="flex flex-col gap-6">
                    <label htmlFor="fullname" className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-row items-center border h-14 border-gray-300 rounded-lg px-4 gap-4">
                            <div>
                                <i data-feather="user" className="text-gray-500"></i>
                            </div>
                            <input className="flex-1 outline-none placeholder:text-sm placeholder:text-gray-500" id="fullname" type="text" name="fullname" placeholder="Enter Your Full Name" />
                        </div>
                    </label>
                    ...
                    <label htmlFor="password" className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-row items-center border h-14 border-gray-300 rounded-lg px-4 gap-4">
                            ...
                            <input className="flex-1 outline-none placeholder:text-sm placeholder:text-gray-500" id="password" type="password" name="password" placeholder="Enter Your Password" />
                            <div className="flex items-center">
                                <button id="reveal-password" type="button">
                                    <i data-feather="eye" className="text-gray-500"></i>
                                </button>
                            </div>
                        </div>
                    </label>
                    ...
                    <label htmlFor="confirm-password" className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-row items-center border h-14 border-gray-300 rounded-lg px-4 gap-4">
                            ...
                            <input className="flex-1 outline-none placeholder:text-sm placeholder:text-gray-500" id="confirm-password" type="password" name="confirm-password" placeholder="Enter Your Password Again" />
                            <div className="flex items-center">
                                <button id="reveal-confirm-password" type="button">
                                    <i data-feather="eye" className="text-gray-500"></i>
                                </button>
                            </div>
                        </div>
                    </label>
                    <button type="submit" className="border rounded-lg h-11 bg-orange-500 font-normal tracking-wide mb-5 hover:opacity-90 active:scale-95 transition:all duration-300">Register</button>
                </form>


                <span className="text-slate-400 item self-center mb-5">Have An Account?<a href="login.html" className="text-orange-500"> Login</a></span>
                ...
                <div className="flex flex-row gap-5">
                    <div className="flex flex-col md:flex-row items-center justify-center flex-1 gap-4 rounded-2xl p-5 shadow-md hover:opacity-80 cursor-pointer active:scale-95 transition-all duration-300 active:shadow-none">
                        <div><i className="fa-brands fa-facebook text-blue-500 text-4xl md:text-base"></i></div>

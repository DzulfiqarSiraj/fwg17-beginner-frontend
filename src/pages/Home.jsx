                ...
                <div className="flex flex-col md:flex-row h-screen w-full">
                    <div className="flex flex-1 justify-center items-center bg-gradient-to-b from-gray-700 to-gray-950 pt-12 pb-5">
                        <section className="flex flex-col items-start box-border md:mx-28 px-12 py-4 gap-4">
                            ...
                            <button id="started-button" className="text-white text-xs px-4 py-2 box-border border border-[#1A4D2E] bg-[#1A4D2E] rounded-md hover:opacity-90 active:scale-95 transition:all duration-300 cursor-pointer" type="button">Get Started</button>
                            <div className="flex flex-row w-full justify-between divide-x">
                                <div className="flex flex-1 flex-col gap-3 pr-10 md:pr-0">
                                    <span className="text-3xl text-[#FF9F29] ">90+</span>
                                    <span className="text-xs text-white">Staffs</span>
                                </div>
                                <div className="flex flex-col flex-1 pl-10 pr-10 md:pr-0 gap-3">
                                    <span className="text-3xl text-[#FF9F29]">30+</span>
                                    <span className="text-xs text-white">Stores</span>
                                </div>
                                <div className="flex flex-col flex-1 pl-10 gap-3">
                                    <span className="text-3xl text-[#FF9F29]">800+</span>
                ...
                <div className="flex flex-row items-center justify-center h-fit bg-gradient-to-b from-[#0a2013] to-[#061009]">
                    <div className="flex flex-col md:flex-row w-3/4 my-14 gap-6">
                        ...
                        <section className="flex flex-col self-start flex-1 gap-4">
                            ...
                            <span className="text-white text-4xl border-[#FF9F29] border-l-4 py-1 pl-5 tracking-wide font-semibold">Viezh Robert</span>
                            <span className="text-[#FF9F29] tracking-wide text-base">Manager Coffee Shop</span>
